...
from .views import PacientesListCreateView, PacientesDetailView, DoctoresListCreateView, DoctoresDetailView, CitasListCreateView, CitasDetailView, EspecialidadesListCreateView, EspecialidadesDetailView, DoctoresEspecialidadesListCreateView, DoctoresEspecialidadesDetailView
